...
CREATE TABLE "ChessUser" (
    ...
    CONSTRAINT "ChessUser_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ChessUser_username_key" ON "ChessUser"("username");

-- CreateIndex
CREATE UNIQUE INDEX "ChessUser_email_key" ON "ChessUser"("email");

-- CreateIndex
CREATE INDEX "ChessUser_rating_idx" ON "ChessUser"("rating");
...
-- AddForeignKey
ALTER TABLE "Game" ADD CONSTRAINT "Game_whitePlayerId_fkey" FOREIGN KEY ("whitePlayerId") REFERENCES "ChessUser"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Game" ADD CONSTRAINT "Game_blackPlayerId_fkey" FOREIGN KEY ("blackPlayerId") REFERENCES "ChessUser"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
